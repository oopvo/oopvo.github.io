...
{% include gloss.html term="Llama" %} 3 405B 是当时最大的开源密集模型（非 MoE），在 15.6T tokens 上训练，使用 30.8M H100 GPU 小时。

### 训练流程

```
预训练 ──────▶ SFT ──────────▶ PPO ──────────▶ DPO
15.6T tokens   指令微调        强化学习          偏好优化
30.8M GPU 时   人工标注数据     Reward Model    偏好对齐
```
